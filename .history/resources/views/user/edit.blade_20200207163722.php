          ...
          <form action="{{ url('task/'.$auth->id) }}" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6 control-info">
                <input type="text" name="user-name" id="task-name" class="form-control" value="{{ $auth->name }}">
              </div>
            </div>
            <!-- メールアドレス -->
            <div class="form-group">
            <label for="email" class="col-sm-3 control-label">メールアドレス</label>
              <div class="col-sm-6 control-info">
                <input type="text" name="email" id="task-name" class="form-control" value="{{ $auth->email }}">
              </div> 
            </div>
                <!-- Add Task Button -->
                <div class="form-group">
